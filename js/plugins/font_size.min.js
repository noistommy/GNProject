       ...
       return { apply: function(e) {
           ...
           a.length ? n
                 ...
                 .scrollTop(
                   a.offset().top -
                     n.offset().top -
                     (n.parent().outerHeight() / 2 - a.outerHeight() / 2)
                 ) : n.parent().scrollTop(0);
         }, refresh: function(e) {
           if (o.opts.fontFamilySelection) {
             ...
             e
               ...
               .text(
                 o.opts.fontFamily[f()] ||
                   t[0] ||
                   o.language.translate(o.opts.fontFamilyDefaultSelection)
               );
           }
         } };
